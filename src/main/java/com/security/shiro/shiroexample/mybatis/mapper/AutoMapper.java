...
import com.security.shiro.shiroexample.mybatis.mapper.annotation.CountSql;
import com.security.shiro.shiroexample.mybatis.mapper.exception.AutoMapperException;
...
public class AutoMapper<T> implements InvocationHandler {
    ...
    private MysqlBaseDao baseDao;

    public AutoMapper(MysqlBaseDao baseDao,Class<T> mapperInterface) {
