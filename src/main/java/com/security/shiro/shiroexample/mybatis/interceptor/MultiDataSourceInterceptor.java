/*
package com.security.shiro.shiroexample.mybatis.interceptor;

import com.alibaba.fastjson.JSONObject;

import com.zfb.platform.common.ContextHolder;
import com.zfb.platform.common.LoggerConstants;
...
public class MultiDataSourceInterceptor extends com.zfb.platform.service.base.datasource.mybatis.interceptor.AbstractInterceptor {
    ...
    public Object intercept(Invocation invocation) throws Throwable {
        ...
        logger.info("[sql]" + ContextHolder.getDataSource() + ":"
                + sql + ":" + (boundSql.getParameterObject()==null?
                null: JSONObject.toJSONString(boundSql.getParameterObject())));
        return result;
    }
