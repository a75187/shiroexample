...
public interface MysqlBaseDao {
	 ...
	 * @param statementCount 查询总数的sql，可能会造成严重的性能瓶颈，建议新写一条，若确认没有性能问题，也可复用statement
	 * @param parameter 传参
     */
	<T> Pagination<T> selectList(String statement, String statementCount, Object parameter, Pagination<T> page);
	/**
	 * 查询结果集总数
	 */
