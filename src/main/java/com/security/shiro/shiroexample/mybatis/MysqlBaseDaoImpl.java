package com.security.shiro.shiroexample.mybatis;


import com.security.shiro.shiroexample.mybatis.mapper.MysqlBaseDao;
import com.security.shiro.shiroexample.mybatis.mapper.Pagination;
...
public class MysqlBaseDaoImpl extends SqlSessionDaoSupport implements MysqlBaseDao {
	...
	@Override
	public <T> Pagination<T> selectList(String statement, String statementCount, Object parameter, Pagination<T> page) {
		if (page == null) {
			page = new Pagination<>();
		}
